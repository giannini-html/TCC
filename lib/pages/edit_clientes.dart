        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              if (usuario.enderecoAtual != null) ...[
                _buildAddressFields(usuario.enderecoAtual!),
              ] else ...[
              ...
              const SizedBox(height: 8.0),
              if (usuario.enderecoObra != null) ...[
                _buildAddressFields(usuario.enderecoObra!),
              ] else ...[
                const Text('Endereço não disponível'),
              ],
            ],
      ...
      build: (pw.Context context) {
        return pw.Column(
          children: [
            ...
            _buildPdfAddressFields(usuario.enderecoAtual!),
            pw.SizedBox(height: 12),
            pw.Text('Endereço da Obra:'),
            pw.SizedBox(height: 8),
            _buildPdfAddressFields(usuario.enderecoObra!),
          ],
        );
      },
    ));
